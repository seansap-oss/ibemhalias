  ...
  return (
    <section className="bg-[radial-gradient(circle_at_top,_#eef3ff_0,_#ffffff_40%,_#ffffff_100%)] pt-24">
      <div className="mx-auto max-w-[1500px] px-4 pb-12 sm:px-6 lg:px-8">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="relative">
              <div className="pointer-events-none absolute inset-y-5 right-[-42px] hidden lg:block">
                {[4, 3, 2, 1].map((depth) => {
                  const story = stories[(active + depth) % stories.length];
                  return (
                    <div
                      key={`${story.label}-${depth}`}
                      className="absolute inset-y-0 right-0 w-[88%] overflow-hidden rounded-[28px] border border-white/50 shadow-xl"
                      style={{
                        transform: `translateX(${depth * 14}px) scale(${1 - depth * 0.02})`,
                        zIndex: 10 - depth,
                      }}
                    >
              ...
              <div className="relative z-20 aspect-[9/16] overflow-hidden rounded-[28px] bg-[#14256f] shadow-2xl shadow-blue-950/15 sm:aspect-[16/10] lg:aspect-[16/9]">
        ...
        <div className="fixed bottom-5 left-4 z-40 flex flex-col gap-2">
          <a
            href="tel:"
            aria-label="Call us"
