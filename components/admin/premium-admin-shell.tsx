...
const horizontalNav: NavItem[] = [
  ...
  { href: "/admin/integrations/zoom", label: "Zoom Integration", icon: Radio },
  { href: "/admin/data-vault", label: "Data Vault", icon: Files },
...
const clientNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/teachers", label: "Teacher Accounts", icon: Users },
      { href: "/admin/integrations/zoom", label: "Zoom Webinar Integration", icon: Radio },
      { href: "/admin/data-vault", label: "Local Data Vault", icon: Files },
